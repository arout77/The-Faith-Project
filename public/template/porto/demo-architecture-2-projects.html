...
<html lang="en">
	<head>
		...
		<title>Demo Architecture 2 | Porto - Multipurpose Website Template</title>	
									...
									<div class="header-nav-main header-nav-main-arrows header-nav-main-mobile-dark header-nav-main-dropdown-no-borders header-nav-main-effect-3 header-nav-main-sub-effect-1">
										<nav class="collapse">
											<ul class="nav nav-pills" id="mainNav">
												...
												<li><a href="demo-architecture-2-projects.html" class="nav-link active">Projects</a></li>
												<li class="dropdown">
			...
			<div role="main" class="main">
								...
								<div class="row">
									<div class="col-md-12 align-self-center p-static text-center">
										<div class="overflow-hidden mb-2">
											<h1 class="font-weight-black text-12 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="1200">Projects</h1>
										</div>
									</div>
				...
				<div class="custom-page-wrapper pt-5 pb-1">
					<div class="container container-xl-custom pt-5 mt-5">
						...
						<div class="row mb-4">
							<div class="col">
								<ul class="nav nav-pills sort-source custom-nav-filter justify-content-center pb-2 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="2100" data-sort-id="portfolio" data-option-key="filter" data-plugin-options="{'layoutMode': 'masonry', 'filter': '*'}">
									<li class="nav-item active" data-option-value="*"><a class="nav-link active" href="#">VIEW ALL</a></li>
									<li class="nav-item" data-option-value=".design-planning"><a class="nav-link" href="#">DESIGN AND PLANNING</a></li>
									<li class="nav-item" data-option-value=".interior-design"><a class="nav-link" href="#">INTERIOR DESIGN</a></li>
									<li class="nav-item" data-option-value=".exterior-design"><a class="nav-link" href="#">EXTERIOR DESIGN</a></li>
									<li class="nav-item" data-option-value=".construction-drawings"><a class="nav-link" href="#">CONSTRUCTION DRAWINGS</a></li>
								</ul>
										...
										<div class="col-sm-6 col-md-4 isotope-item design-planning">
											<div class="portfolio-item mb-3 pb-1">
												<a href="demo-architecture-2-projects-detail.html">
													<div class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-icons border-radius-0">
														<div class="thumb-info-wrapper border-radius-0">
															<img src="img/demos/architecture-2/projects/project-1.jpg" class="img-fluid border-radius-0" alt="">
															<div class="thumb-info-action flex-column align-items-center">
																<h4 class="text-color-light font-weight-bold line-height-2 text-6 ls-0 mb-0">Project Name</h4>
																<p class="font-weight-semibold text-color-grey text-2 mb-0">DESIGN AND PLANNING</p>
															</div>
														</div>
													</div>
												</a>
										...
										<div class="col-sm-6 col-md-4 isotope-item interior-design">
											<div class="portfolio-item mb-3 pb-1">
												<a href="demo-architecture-2-projects-detail.html">
													<div class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-icons border-radius-0">
														<div class="thumb-info-wrapper border-radius-0">
															<img src="img/demos/architecture-2/projects/project-2.jpg" class="img-fluid border-radius-0" alt="">
															<div class="thumb-info-action flex-column align-items-center">
																<h4 class="text-color-light font-weight-bold line-height-2 text-6 ls-0 mb-0">Project Name</h4>
																<p class="font-weight-semibold text-color-grey text-2 mb-0">DESIGN AND PLANNING</p>
															</div>
										...
										<div class="col-sm-6 col-md-4 isotope-item exterior-design">
											<div class="portfolio-item mb-3 pb-1">
												<a href="demo-architecture-2-projects-detail.html">
													<div class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-icons border-radius-0">
														<div class="thumb-info-wrapper border-radius-0">
															<img src="img/demos/architecture-2/projects/project-3.jpg" class="img-fluid border-radius-0" alt="">
															<div class="thumb-info-action flex-column align-items-center">
																<h4 class="text-color-light font-weight-bold line-height-2 text-6 ls-0 mb-0">Project Name</h4>
																<p class="font-weight-semibold text-color-grey text-2 mb-0">DESIGN AND PLANNING</p>
															</div>
										...
										<div class="col-sm-6 col-md-4 isotope-item construction-drawings">
											<div class="portfolio-item mb-3 pb-1">
												<a href="demo-architecture-2-projects-detail.html">
													<div class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-icons border-radius-0">
														<div class="thumb-info-wrapper border-radius-0">
															<img src="img/demos/architecture-2/projects/project-4.jpg" class="img-fluid border-radius-0" alt="">
															<div class="thumb-info-action flex-column align-items-center">
																<h4 class="text-color-light font-weight-bold line-height-2 text-6 ls-0 mb-0">Project Name</h4>
																<p class="font-weight-semibold text-color-grey text-2 mb-0">DESIGN AND PLANNING</p>
															</div>
										...
										<div class="col-sm-6 col-md-4 isotope-item construction-drawings">
											<div class="portfolio-item mb-3 pb-1">
												<a href="demo-architecture-2-projects-detail.html">
													<div class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-icons border-radius-0">
														<div class="thumb-info-wrapper border-radius-0">
															<img src="img/demos/architecture-2/projects/project-5.jpg" class="img-fluid border-radius-0" alt="">
															<div class="thumb-info-action flex-column align-items-center">
																<h4 class="text-color-light font-weight-bold line-height-2 text-6 ls-0 mb-0">Project Name</h4>
																<p class="font-weight-semibold text-color-grey text-2 mb-0">DESIGN AND PLANNING</p>
															</div>
										...
										<div class="col-sm-6 col-md-4 isotope-item design-planning">
											<div class="portfolio-item mb-3 pb-1">
												<a href="demo-architecture-2-projects-detail.html">
													<div class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-icons border-radius-0">
														<div class="thumb-info-wrapper border-radius-0">
															<img src="img/demos/architecture-2/projects/project-6.jpg" class="img-fluid border-radius-0" alt="">
															<div class="thumb-info-action flex-column align-items-center">
																<h4 class="text-color-light font-weight-bold line-height-2 text-6 ls-0 mb-0">Project Name</h4>
																<p class="font-weight-semibold text-color-grey text-2 mb-0">DESIGN AND PLANNING</p>
															</div>
